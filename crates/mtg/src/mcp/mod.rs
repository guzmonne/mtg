...
impl ServerHandler for MtgMcpServer {
                ...
                resources: vec![
                    ...
                    Annotated {
                        raw: RawResource {
                            ...
                            description: Some("Card types, subtypes, supertypes, and formats".to_string()),
                            mime_type: Some("application/json".to_string()),
                            size: None,
                        },
                        annotations: Default::default(),
    ...
    fn read_resource(
        ...
        async move {
            match params.uri.as_str() {
                "mtg://cards" => resources::read_cards_resource(&self.client, &self.api_base_url).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                "mtg://sets" => resources::read_sets_resource(&self.client, &self.api_base_url).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                "mtg://types" => resources::read_types_resource(&self.client, &self.api_base_url).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                _ => Err(rmcp::ErrorData::new(ErrorCode::RESOURCE_NOT_FOUND, format!("Unknown resource URI: {}", params.uri), None)),
            }
        }
    }
    ...
    fn call_tool(
        ...
        async move {
            match params.name.as_ref() {
                "search_cards" => tools::search_cards(&self.client, &self.api_base_url, params.arguments.map(|args| serde_json::Value::Object(args))).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                "get_card" => tools::get_card(&self.client, &self.api_base_url, params.arguments.map(|args| serde_json::Value::Object(args))).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                "list_sets" => tools::list_sets(&self.client, &self.api_base_url, params.arguments.map(|args| serde_json::Value::Object(args))).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                "generate_booster" => tools::generate_booster(&self.client, &self.api_base_url, params.arguments.map(|args| serde_json::Value::Object(args))).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                "get_card_types" => tools::get_card_types(&self.client, &self.api_base_url, params.arguments.map(|args| serde_json::Value::Object(args))).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                _ => Err(rmcp::ErrorData::new(ErrorCode::METHOD_NOT_FOUND, format!("Unknown tool: {}", params.name), None)),
            }
        }
    }
    ...
    fn get_prompt(
        ...
        async move {
            match params.name.as_ref() {
                "analyze_card" => prompts::analyze_card_prompt(&self.client, &self.api_base_url, params.arguments.map(|args| serde_json::Value::Object(args))).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                "build_deck" => prompts::build_deck_prompt(&self.client, &self.api_base_url, params.arguments.map(|args| serde_json::Value::Object(args))).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                "compare_cards" => prompts::compare_cards_prompt(&self.client, &self.api_base_url, params.arguments.map(|args| serde_json::Value::Object(args))).await
                    .map_err(|e| rmcp::ErrorData::new(ErrorCode::INTERNAL_ERROR, e.to_string(), None)),
                _ => Err(rmcp::ErrorData::new(ErrorCode::METHOD_NOT_FOUND, format!("Unknown prompt: {}", params.name), None)),
            }
        }
    }
